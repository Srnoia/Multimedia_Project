...
Wall.prototype.draw = function(x){
  this.x = x;
  ctx.drawImage(spriteSheet, this.typeX*spriteSheetWidth, this.typeY*spriteSheetHeight, spriteSheetWidth, spriteSheetHeight, this.x, this.y, spriteWidth, spriteHeight);
}
